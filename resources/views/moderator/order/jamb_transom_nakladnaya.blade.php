...
<table class="table table-bordered w-100">
    <tbody>
        ...
        <tr>
            ...
            <td>Shartnoma raqami: {{ $order[0]->id }}/{{ $order[0]->contract_number }}({{ $transoms[0]->name }} {{ $transoms[0]->transom_color }}) ({{ $jambs[0]->name }} {{ $jambs[0]->jamb_color }})</td>
        </tr>
        <tr>
            ...
            @foreach($transoms as $key => $value)
                @if (!empty($value->name) && $value->name != "")
                    ...
                    <tr>
                        ...
                        <td class="align-middle">{{ $value->name }}x{{ $value->height }}x{{ $value->width_top }}x{{ $value->width_bottom }}</td>
