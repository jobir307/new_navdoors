...
@section('content')
  <div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('moderator') }}" class="fw-light">Naryadlar / </a><span class="fw-light">Naryad ma'lumotlarini ko'rish(dobor)</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
                  ...
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center align-middle">Dobor rangi</th>
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              <form action="{{ route('transom-show-pdf') }}" method="POST">
                @csrf
