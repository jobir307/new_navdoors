...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('cashier', $date=date('Y-m-d')) }}" class="fw-light">Asosiy / </a><a href="{{ route('ins', $inout_type=1) }}" class="fw-light">Kirim / </a><span class="text-muted fw-light">To'lov tarixi</span></h4>
    <div class="row">
      <div class="col-md-12">
