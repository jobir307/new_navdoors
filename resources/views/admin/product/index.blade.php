...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('dashboard') }}" class="fw-light">Asosiy / </a>Tovarlar</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <div class="card-header">Yangi tovar yaratish</div>
          <div class="card-body">
            @if (isset($product))
            ...
            @endif
              ...
              <div class="row">
                <div class="mb-3 col-md-8">
                  <label for="name" class="form-label">Tovar nomi</label>
                  <input class="form-control" type="text" id="name" name="name" autofocus autocomplete="off" value="{{ $product->name ?? ''  }}" />
                </div>
                    ...
                    @foreach($products as $key => $value)
                      <tr>
                        ...
                        <td class="text-sm-end">
                          ...
                          <a href="{{ route('products.edit', $value->id) }}" class="btn-sm btn btn-icon btn-outline-primary">
