...
@section('content')
  <div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('orders') }}" class="fw-light">Shartnomalar / </a><span class="fw-light">Shartnoma ma'lumotlarini ko'rish(nalichnik va dobor)</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="row">
            <div class="col-md-12 m-3">
              ...
              @endif
              <a href="{{ url('pdf-order-jamb-transom', $order[0]->id) }}" class="btn btn-outline-secondary" title="Chop etish">
