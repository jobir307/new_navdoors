...
<div class="container-fluid flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><a href="{{ route('orders') }}" class="fw-light">Shartnomalar / </a><span class="fw-light">Shartnoma ma'lumotlarini ko'rish(dobor)</h4>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th class="text-center align-middle" rowspan=2>Dobor rangi</th>
        ...
        <h3 class="text-center text-primary mt-4">Dobor ma'lumotlari</h3>
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive text-nowrap m-3">
        ...
        <div class="row">
          <div class="col-md-12 m-3">
            ...
            @endif
            <a href="{{ url('pdf-order-transom', $order[0]->id) }}" class="btn btn-outline-secondary" title="Chop etish">
              <i class="bx bx-printer"></i>PDFga yuklash
            </a>
            @if ((Auth::user()->role_id == 1 || Auth::user()->id == $order[0]->who_created_userid) && $order[0]->status == 0)
              <a href="{{ route('order-transoms.edit', $order[0]->id) }}" class="btn btn-outline-primary" title="O'zgartirish">
