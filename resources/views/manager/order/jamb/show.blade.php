        ...
        <div class="card">
          ...
          <div class="row">
            <div class="col-md-12 m-3">
              ...
              @endif
              <a href="{{ url('pdf-order-jamb', $order[0]->id) }}" class="btn btn-outline-secondary" title="Chop etish">
                <i class="bx bx-printer"></i>PDFga yuklash
              </a>
              @if ((Auth::user()->role_id == 1 || Auth::user()->id == $order[0]->who_created_userid) && $order[0]->status == 0)
                <a href="{{ route('order-jambs.edit', $order[0]->id) }}" class="btn btn-outline-primary" title="O'zgartirish">
