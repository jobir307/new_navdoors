...
@section('content')
  <div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('orders') }}" class="fw-light">Shartnomalar / </a><span class="fw-light">Yangi shartnoma yaratish(nalichnik, korona, kubik va sapog)</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <form method="POST"  action="{{ route('order-ccbjs.store') }}">
            @csrf
            <div class="card-body">
              <div class="row">
                ...
                <div class="mb-3 col-md-1">
                  ...
                  <input class="form-control" type="text" name="crown_color" id="crown_color" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-1">
                  <label for="cube_color" class="form-label">Kubik rangi</label>
                  <input class="form-control" type="text" name="cube_color" id="cube_color" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-1">
                  <label for="boot_color" class="form-label">Sapog rangi</label>
                  <input class="form-control" type="text" name="boot_color" id="boot_color" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-1">
                    ...
                    <div class="col-md-3 crowns_content">
                        <div class="row mt-4 crown_div" data-index="0">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input class="form-control" type="number" name="door_width[]" id="door_width" autocomplete="off" />
                            </div>
                            <div class="mb-3 col-md-3">
                                <label for="count" class="form-label">Soni</label>
                                <input class="form-control" type="number" name="crown_count[]" id="count" autocomplete="off" />
                            </div>
                        </div>
                    </div>
