...
@section('content')
  <div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('orders') }}" class="fw-light">Shartnomalar / </a><span class="fw-light">Shartnoma ma'lumotlarini ko'rish (nalichnik, karona, kubik va sapog)</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle" colspan=12>{{ $order[0]->comments }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <h3 class="text-center text-primary mt-4">Nalichnik, karona, kubik va sapog ma'lumotlari</h3>
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive text-nowrap m-3">
          ...
          <div class="row">
            <div class="col-md-12 m-3">
              ...
              @endif
              <a href="{{ url('pdf-order-ccbj', $order[0]->id) }}" class="btn btn-outline-secondary" title="Chop etish">
                <i class="bx bx-printer"></i>PDFga yuklash
              </a>
              @if ((Auth::user()->role_id == 1 || Auth::user()->id == $order[0]->who_created_userid) && $order[0]->status == 0)
                <a href="{{ route('order-ccbjs.edit', $order[0]->id) }}" class="btn btn-outline-primary" title="O'zgartirish">
