...
@section('content')
  <div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('orders') }}" class="fw-light">Shartnomalar / </a><span class="fw-light">Yangi shartnoma yaratish(nostandart nalichnik)</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <form method="POST"  action="{{ route('order-nsjambs.store') }}">
            @csrf
            <div class="card-body jambs_content">
              ...
              <div class="row mt-4 jamb_div justify-content-end" data-index="0">
                ...
                <div class="mb-3 col-md-2">
                    ...
                    <input class="form-control" type="number" name="jamb_height[]" id="jamb_height" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-2">
                    <label for="width_top" class="form-label">Eni (tepa)</label>
                    <input class="form-control" type="number" name="jamb_width_top[]" id="width_top" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-2">
                    <label for="width_bottom" class="form-label">Eni (past)</label>
                    <input class="form-control" type="number" name="jamb_width_bottom[]" id="width_bottom" autocomplete="off" />
                </div>
                <div class="mb-3 col-md-2">
        ...
        <div class="row mt-4 jamb_div_without_labels" style="display:none;">
            <div class="mb-3 col-md-4">
                <select class="form-select" name="jamb_id[]">
                    <option value=""></option>
                    @foreach($nsjambs as $key => $value)
                        <option value="{{ $value->id }}">{{ $value->jambname }}</option>
                    @endforeach
